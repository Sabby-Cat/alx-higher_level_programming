...
Unittest classes:
    ...
    TestBase_load_from_file - line 334
    TestBase_save_to_file_csv - line 399
    TestBase_load_from_file_csv - line 476
"""
import os
import unittest
...
class TestBase_load_from_file(unittest.TestCase):
    """test load_from_file_method of Base"""
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """test save_to_file_csv method of Base"""
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """test load_from_file_csv method of Base"""
    @classmethod
    def tearDown(self):
        """Delete any created files."""
        try:
